    ...
    <div className="container-custom flex flex-col items-center justify-center text-center">
      <Card className="max-w-4xl w-full">
        <CardContent className="p-8">
          <h2 className="text-3xl font-bold mb-2 text-primary uppercase">
            TRUNG TÂM GIA SƯ HOÀNG HÀ
          </h2>
          <div className="text-accent-foreground font-semibold text-lg mb-4">
          ...
          <p className="text-lg text-foreground mb-4">
            ...
            Thành phố Thanh Hoá, nơi hội tụ đội ngũ giáo viên giỏi chuyên môn, tận tâm và am hiểu
            sâu sắc chương trình Giáo dục địa phương. Chúng tôi cam kết mang đến những tiết học chất
