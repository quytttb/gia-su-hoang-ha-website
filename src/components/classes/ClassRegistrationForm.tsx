    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-4">Thông tin Phụ Huynh</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground mb-4">Thông tin Học Viên</h2>
            <FormField
              control={form.control}
              name="name"
              render={({ field }) => (
