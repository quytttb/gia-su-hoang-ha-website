...
const testDataSets = [
  {
    ...
    data: {
      ...
      academicDescription:
        'Học sinh khá, cần cải thiện môn Toán và Vật Lý. Có hứng thú với môn Văn và Tiếng Anh.',
    },
  },
  {
    name: 'Dataset 2',
  ...
  },
  {
    ...
    data: {
      ...
      parentAddress:
        'Địa chỉ rất dài để test validation: 123/456/789 Đường ABCDEFGHIJK, Phường MNOPQRST, Quận UVWXYZ, TP.HCM, Việt Nam',
      name: 'Học Sinh Có Tên Rất Dài',
      school: 'Trường THPT Có Tên Rất Dài Để Test',
      academicDescription:
        'Mô tả rất dài về lực học của học sinh để test validation giới hạn ký tự và xem form có xử lý được không. Học sinh này có nhiều điểm mạnh và yếu cần được hỗ trợ.',
    },
  },
];
