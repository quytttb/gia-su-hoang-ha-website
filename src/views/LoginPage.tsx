    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Dành cho nhân viên và quản trị viên</p>
        </div>
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md p-4">
            ...
            <div className="text-xs text-yellow-700 dark:text-yellow-400 space-y-1">
              <p>
                <strong>Admin:</strong> admin@giasuhoangha.com / admin123
              </p>
              <p>
                <strong>Staff:</strong> staff@giasuhoangha.com / staff123
              </p>
            </div>
          </div>
        )}
